...
$(document).ready(function () {
  $('input[name="phone"]').inputmask({
    mask: "+995 (999) 99-99-99", // Маска для грузинського номера
    clearIncomplete: false, // Не очищати поле, якщо воно заповнене частково
    showMaskOnHover: true, // Показувати маску при наведенні
    showMaskOnFocus: true, // Показувати маску при фокусі
    placeholder: "_", // Заповнювач для незаповнених полів
    prefix: "+995 ", // Фіксований префікс
  });
});
